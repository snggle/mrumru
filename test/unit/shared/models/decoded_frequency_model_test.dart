...
void main() {
  group('Test of DecodedFrequencyModel.calcBinary()', () {
    ...
    test('Should [return calculated binary] from given [chunk frequency = 2200] on specified [chunkIndex = 1]', () {
      // Arrange
      DecodedFrequencyModel actualDecodedFrequencyModel = const DecodedFrequencyModel(chunkFrequency: 1800, chunkIndex: 1);
    ...
    test('Should [return calculated binary] from given [chunk frequency = 3400] on specified [chunkIndex = 2]', () {
      // Arrange
      DecodedFrequencyModel actualDecodedFrequencyModel = const DecodedFrequencyModel(chunkFrequency: 2600, chunkIndex: 2);
    ...
    test('Should [return calculated binary] from given [chunk frequency = 4600] on specified [chunkIndex = 3]', () {
      // Arrange
      DecodedFrequencyModel actualDecodedFrequencyModel = const DecodedFrequencyModel(chunkFrequency: 3400, chunkIndex: 3);
    ...
    test('Should [return calculated binary] from given [chunk frequency = 5800] on specified [chunkIndex = 4]', () {
      // Arrange
      DecodedFrequencyModel actualDecodedFrequencyModel = const DecodedFrequencyModel(chunkFrequency: 4200, chunkIndex: 4);
    ...
    test('Should [return calculated binary] from given [chunk frequency = 7000] on specified [chunkIndex = 5]', () {
      // Arrange
      DecodedFrequencyModel actualDecodedFrequencyModel = const DecodedFrequencyModel(chunkFrequency: 5000, chunkIndex: 5);
    ...
    test('Should [return calculated binary] from given [chunk frequency = 8200] on specified [chunkIndex = 6]', () {
      // Arrange
      DecodedFrequencyModel actualDecodedFrequencyModel = const DecodedFrequencyModel(chunkFrequency: 5800, chunkIndex: 6);
    ...
    test('Should [return calculated binary] from given [chunk frequency = 9400] on specified [chunkIndex = 7]', () {
      // Arrange
      DecodedFrequencyModel actualDecodedFrequencyModel = const DecodedFrequencyModel(chunkFrequency: 6600, chunkIndex: 7);
