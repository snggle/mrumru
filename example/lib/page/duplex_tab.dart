  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: BlocBuilder<DuplexTabCubit, DuplexTabState>(
        ...
        builder: (BuildContext buildContext, DuplexTabState duplexTabState) {
          return Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  enabled: duplexTabState.processingBool == false,
                  maxLines: 6,
                ...
                ValueListenableBuilder<TextEditingValue>(
                  ...
                  builder: (BuildContext context, TextEditingValue textEditingValue, _) {
                    return Row(
                      children: <Widget>[
                        InkWell(
                          onTap: duplexTabState.processingBool ? null : widget.duplexTabCubit.sendingTextController.clear,
                ...
                Row(
                  children: <Widget>[
                    Expanded(
                      child: Opacity(
                        opacity: duplexTabState.processingBool == false ? 1.0 : 0.5,
                        child: OutlinedButton(
                          onPressed: duplexTabState.processingBool == false ? () => widget.duplexTabCubit.send() : null,
                    ...
                    Expanded(
                      child: Opacity(
                        opacity: duplexTabState.processingBool ? 0.5 : 1.0,
                        child: OutlinedButton(
                          onPressed: duplexTabState.processingBool == false ? () => widget.duplexTabCubit.receive() : null,
                    ...
                    Expanded(
                      child: Opacity(
                        opacity: duplexTabState.processingBool ? 1.0 : 0.5,
                        child: OutlinedButton(
                          onPressed: duplexTabState.processingBool ? widget.duplexTabCubit.stopProcess : null,
