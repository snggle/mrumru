            ...
            child: ListView(
              children: <Widget>[
                ...
                NumericField(
                  ...
                  onFieldSubmitted: (int value) => audioEmissionCubit.audioSettingsModel.baseFrequency = value,
                  textController: TextEditingController(text: audioEmissionCubit.audioSettingsModel.baseFrequency.toString()),
                ),
                NumericField(
                  fieldName: 'frequencyStep',
                  onFieldSubmitted: (int value) => audioEmissionCubit.audioSettingsModel.frequencyStep = value,
                  textController: TextEditingController(text: audioEmissionCubit.audioSettingsModel.frequencyStep.toString()),
                ),
                NumericField(
                  fieldName: 'sampleRate',
                  onFieldSubmitted: (int value) => audioEmissionCubit.audioSettingsModel.sampleRate = value,
                  textController: TextEditingController(text: audioEmissionCubit.audioSettingsModel.sampleRate.toString()),
                ),
                NumericField(
                  fieldName: 'bitDepth',
                  onFieldSubmitted: (int value) => audioEmissionCubit.audioSettingsModel.bitDepth = value,
                  textController: TextEditingController(text: audioEmissionCubit.audioSettingsModel.bitDepth.toString()),
                ),
                NumericField(
                  fieldName: 'channels',
                  onFieldSubmitted: (int value) => audioEmissionCubit.audioSettingsModel.channels = value,
                  textController: TextEditingController(text: audioEmissionCubit.audioSettingsModel.channels.toString()),
                ),
                NumericField(
                  fieldName: 'symbolDuration',
                  onFieldSubmitted: (int value) => audioEmissionCubit.audioSettingsModel.symbolDuration = value,
                  textController: TextEditingController(text: audioEmissionCubit.audioSettingsModel.symbolDuration.toString()),
                ),
                NumericField(
                  fieldName: 'bitsPerFrequency',
                  onFieldSubmitted: (int value) => audioEmissionCubit.audioSettingsModel.bitsPerFrequency = value,
